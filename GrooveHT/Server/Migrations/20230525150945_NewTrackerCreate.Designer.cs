...
namespace GrooveHT.Server.Migrations
{
    ...
    [Migration("20230525150945_NewTrackerCreate")]
    partial class NewTrackerCreate
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GrooveHT.Server.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("GrooveHT.Server.Models.ProfileEntity", b =>
                {
                    b.HasOne("GrooveHT.Server.Models.TrackerEntity", "TrackerEntity")
                        .WithMany()
                        .HasForeignKey("InProgress")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("TrackerEntity");
                });
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("GrooveHT.Server.Models.ApplicationUser", null)
                        .WithMany()
